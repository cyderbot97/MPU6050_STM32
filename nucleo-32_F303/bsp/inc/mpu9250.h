...
void 	BSP_MPU9250_SPI_Init	(void);
uint8_t	BSP_MPU9250_WHOAMI		(void);
void 	BSP_MPU9250_Init		(void);
void	BSP_MPU9250_EXTI_Init	(void);

void 	BSP_MPU9250_ReadRegs	(uint8_t readAddr, uint8_t *readBuf, uint8_t bytes);
uint8_t BSP_MPU9250_WriteReg	(uint8_t writeAddr, uint8_t writeData);

// Private functions

static uint8_t MPU9250_SPI_SendByte		(uint8_t byte);
